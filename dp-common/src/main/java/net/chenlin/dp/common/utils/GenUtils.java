...
//        String jdbcUrl = "jdbc:mysql://192.168.180.130:3306/dp-lte?useUnicode=true&characterEncoding=utf-8";
        String jdbcUrl = "jdbc:mysql://rm-m5e119oojroo43176uo.mysql.rds.aliyuncs.com:3306/dp-lte?useUnicode=true&characterEncoding=utf-8";
        String jdbcUsername = "wzh_root";
        String jdbcPassword = "Wyang1025";
...
//        String webModule = "base";
        String javaProject = "dp-tool";
        String webProject = "dp-web";
        String javaModule = "tool";
        String webModule = "tool";
